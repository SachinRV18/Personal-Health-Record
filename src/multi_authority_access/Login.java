...
public class Login extends javax.swing.JFrame {
   ...
   Statement st,st1;
   ResultSet rs; 
   public static String name,username,phone;

    public Login(Connection conn, Statement st, Statement st1, ResultSet rs, JButton jButton1, JButton jButton2, JCheckBox jCheckBox1, JCheckBox jCheckBox2, JLabel jLabel1, JLabel jLabel2, JLabel jLabel3, JLabel jLabel4, JPanel jPanel1, JPasswordField jPasswordField1, JTextField jTextField1) throws HeadlessException {
        this.conn = conn;
        this.st = st;
        this.st1 = st1;
        this.rs = rs;
   ...
   public static int p=0;
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("D:\\Users\\renisna.a\\Downloads\\l2.png")); // NOI18N
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-20, 0, 720, 650));
            ...
            st = conn.createStatement();
               ...
               while(rs.next())
                {  name=rs.getString(1);
                    ...
                    if(usern.equals(username)&&pass.equals(password)&&sec.equals(secret))
                    {
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        // TODO add your handling code here:
        jLabel4.setText("*User name is Your Email-Id");
